...
- **Focus Mode & Top Focus Banner 🎯**: Mark tasks/groups as active focus (`fo` / `tf` / `<space> t f`, exit via `Esc` or `q`) with top Focus Banner, group indicators, and note previews.
